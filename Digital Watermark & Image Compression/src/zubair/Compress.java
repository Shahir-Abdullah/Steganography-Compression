...
public class Compress{
     ...
     * @param args
     */
    public static void Compress_Image(String imgMain, String imgCom) {
        // class object
        Input_Img gs = new Input_Img(imgMain, imgCom);
        P_Queue pq = new P_Queue();
        Huffman_Encode hc = new Huffman_Encode();
        P_Queue pq2 = new P_Queue();
        Huffman_Encode hc2 = new Huffman_Encode();
        ...
        System.out.println("Compression ratio for part 1 : " + roundOff+(.54));
